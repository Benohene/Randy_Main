    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.CharField(choices=[('Men Haircut', 'Men Haircut'), ('Women Haircut', 'Women Haircut'), ('Kids Haircut', 'Kids Haircut'), ('Hair Coloring', 'Hair Coloring'), ('Hair Styling', 'Hair Styling')], max_length=50)),
